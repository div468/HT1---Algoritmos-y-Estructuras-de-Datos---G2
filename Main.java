            ...
            while (menu){
                ...
                switch (choice) {
                    ...
                    if (licuadora.getEncendido()){
                        ...
                        //Si la velocidad de la licuadora pasa de 10, se regresa la velocidad a 1 como metodo de disminuir la velocidad
                    ...
                    case 7:
                        ...
                        //Se verifica que la licuadora esté encendida
                        if (licuadora.getEncendido()){
                            //Si lo está, procede a apagarse asignando los valores correspondientes, además se notifica
